...
(def app-state
  (atom {:yourname "your name"
         :rooms {"Pop" {:users 15 :id (guid)}
                 "Metal" {:users 702 :id (guid)}
                 "Justin Bieber" {:users 2006 :id (guid)}
                 "Funk" {:users 66 :id (guid)}
                 "Jazz" {:users 26 :id (guid)}
                 "Electro" {:users 306 :id (guid)}
                 "Hardcore" {:users 126 :id (guid)}
                 "Classic" {:users 26 :id (guid)}
                 "Rock" {:users 6 :id (guid)}
                 "Oldies" {:users 13 :id (guid)}
                 "Experimental" {:users 79 :id (guid)}
                 "RnB" {:users 203 :id (guid)}}
         :releases [
